...
npm install -g yarn &&\
curl -fOL https://github.com/cdr/code-server/releases/download/v4.96.2/code-server_4.96.2_arm64.deb &&\
dpkg -i code-server_4.96.2_arm64.deb ||(echo '继续安装失败！你可以输入./continue.sh重新继续安装' && exit 0)
